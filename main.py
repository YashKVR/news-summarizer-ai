...
class AssistantManager:
    # thread_id = None
    # assistant_id = None
    thread_id = "thread_BL1DMEUguQo6viLHtajM9F3k"
    assistant_id = "asst_UTkRtNXrv0LEJGOTcSb99uDi"
    ...
    def __init__(self, model:str):
        ...
        # Retreive existing assistant and thread if IDs are already existing
    ...
    def call_required_functions(self, required_actions):
        ...
        for action in required_actions["tool_calls"]:
            ...
            print("Submitting outputs back to th assistant...")
...
def main():
    ...
    manager = AssistantManager(model)
